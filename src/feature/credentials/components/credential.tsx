...
const credentialTypeOptions = [
  { label: "OpenAI", value: CredentialType.OPENAI, logo: "/openai.svg" },
  {
    label: "Anthropic",
    value: CredentialType.ANTHROPIC,
    logo: "/anthropic.svg",
  },
  { label: "Gemini", value: CredentialType.GEMINI, logo: "/gemini.svg" },
];
    ...
    <>
      ...
      <Card className="shadow-none">
        <CardHeader>
          ...
          <CardDescription>
            {isEdit
              ? "Update your API Key or credential information below."
