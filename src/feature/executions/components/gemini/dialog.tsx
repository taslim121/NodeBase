...
export const AVAILABLE_MODELS = [
  ...
  // The current standard 'Low Cost' / High Speed model
  "gemini-2.5-flash",

  // Previous generation Flash (very stable, often cheaper)
  "gemini-2.0-flash",

  // The current 'Intelligence' / Pro model
  "gemini-2.5-pro",

  // Previous Pro version (good fallback)
  "gemini-2.0-pro",
] as const;
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Configure settings for the gemini API call and Prompt.
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
          <form
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Teh Prompt to send to the Ai. Use {"{{variables}}"} for
                    simple values or {"{{json variable}}"} to stringify objects.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
