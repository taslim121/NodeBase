...
export const AVAILABLE_MODELS = [
  ...
  "gpt-4o-mini",
  // GPT-4o models (most capable, multimodal)
  "gpt-4o",
  // GPT-4 Turbo (previous generation, still powerful)
  "gpt-4-turbo",
  // GPT-4 (original, stable)
  "gpt-4",
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Configure settings for the OpenAI API call and Prompt.
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
          <form
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    The OpenAI model to use for this request. gpt-4o is the
